...
public final class GrowAPet extends JavaPlugin {
    ...
    private void registerCommands(){command("growapet",new GrowAPetCommand(this));command("plot",new PlotCommand(this));command("pets",new PetsCommand(this));command("stats",new StatsCommand(this));command("boss",new BossCommand(this));command("warp",new WarpCommand(this));command("zones",new ZonesCommand(this));command("visit",new VisitCommand(this));command("leaderboard",new LeaderboardCommand(this));command("getegg",new GetEggCommand(this));command("shop",new ShopCommand(this));command("spawn",new SpawnCommand(this));command("setspawn",new SetSpawnCommand(this));command("store",new StoreCommand(this));command("unlockzone",new UnlockZoneCommand(this));command("quests",new QuestsCommand(this));command("trade",new TradeCommand(this));command("options",new OptionsCommand(this));command("getmob",new GetMobCommand(this));command("getpet",new GetPetCommand(this));command("autokill",new AutoKillCommand(this));command("daily",new DailyCommand(this));command("tutorial",new TutorialCommand(this));GrowAPetTabCompleter completer=new GrowAPetTabCompleter(this);for(String name:List.of("growapet","plot","pets","stats","boss","warp","zones","visit","leaderboard","getegg","shop","spawn","setspawn","store","unlockzone","quests","trade","options","getmob","getpet","autokill","daily","tutorial")){PluginCommand registered=getCommand(name);if(registered!=null)registered.setTabCompleter(safeCompleter(name,completer));}}
