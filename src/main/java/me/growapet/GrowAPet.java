...
public final class GrowAPet extends JavaPlugin {
    ...
    private void initializeManagers(){
        ...
        CompletableFuture.allOf(plotManager.loadAll(),petManager.loadAll(),eggIncubationManager.loadAll(),eventManager.loadAll(),bossManager.loadAll(),tradeManager.initialize(),plotBoostManager.loadAll(),mobSpawnPointManager.loadAll())
    ...
    private void finishEnable(){
        me.growapet.integration.LuckPermsHook.initialize();wallManager.loadAll();registerListeners();virtualTextDisplays.start();mobManager.start();mobSpawnPointManager.start();petManager.start();bossManager.start();eventManager.start();actionBarManager.start();plotBoostManager.start();leaderboardManager.start();relicManager.start();chatGameManager.start();
